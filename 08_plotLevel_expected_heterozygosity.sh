...
output_dir="/data/sp11/14_ExpHetResult/"

mkdir -p $output_dir
output_table="${output_dir}/${str}.ExpHet.csv"

module load GCC/12.2.0 Pysam/0.21.0
python 08_plotLevel_expected_heterozygosity.py $input_vcf $filter_file $diversity_file $output_table
